...
require_once("config.php");
                ...
                $no=1;
$q="select*from tlg where no=1"; $q1=mysqli_query($conn,$q);
?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Tables Admin</li>
      </ol>
      <!-- Example DataTables Card-->
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Data Admin Terdaftar</div>
        <div class="card-body">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <?php
                ...
                <tr>
                  ...
                  <td>
                    <a href="delete_admin.php?username=<?php echo $row['username']; ?>" onclick="return confirm('Anda yakin hapus ?')">Delete</a>
                    <a href="update_admin.php?username=<?php echo $row['username']; ?>">Update</a>
                  </td>
                </tr>
                <?php
                    }
        ...
        <div class="card-footer small text-muted">
          <?php while($q2=mysqli_fetch_array($q1)){ echo "Update: ".$q2['tglup'];} ?>
        </div>
      </div>
    </div>
    <!-- /.container-fluid-->
