    ...
    <body>
        <div>
            ...
            <!-- YEAR(tgl) = '$tahun' -->
                ...
                <br>
                <a href="table_absen.php?tahun=<?=$tahun?>"><img src="icon/panah2.png" width="50px;" alt=""></a>
                <br>
                <a href="print2.php?tahun=<?=$tahun?>" target="blank">Print</a>
            </div>
            <div class="table">
                <table border="0">
                    <thead>
                        ...
                        <?php $y=1;
                            for ($x=0; $x < $jumlah_2; $x++) { ?>
                                <tr>
                                    ...
                                    <td><?php echo $array_HTW   [$x][7]; ?></td>
                                    <td><?php echo $array_TM    [$x][7]; ?></td>
                                    <td><?php echo $array_PSW   [$x][7]; ?></td>
                                    <td><?php echo $array_TK    [$x][7]; ?></td>
                                    <td><?php echo $array_HTW   [$x][8]; ?></td>
                                    <td><?php echo $array_TM    [$x][8]; ?></td>
                                    <td><?php echo $array_PSW   [$x][8]; ?></td>
                                    <td><?php echo $array_TK    [$x][8]; ?></td>
                                    <td><?php echo $array_HTW   [$x][9]; ?></td>
                                    <td><?php echo $array_TM    [$x][9]; ?></td>
                                    <td><?php echo $array_PSW   [$x][9]; ?></td>
                                    <td><?php echo $array_TK    [$x][9]; ?></td>
                                    <td><?php echo $array_HTW   [$x][10]; ?></td>
                                    <td><?php echo $array_TM    [$x][10]; ?></td>
                                    <td><?php echo $array_PSW   [$x][10]; ?></td>
                                    <td><?php echo $array_TK    [$x][10]; ?></td>
                                    <td><?php echo $array_HTW   [$x][11]; ?></td>
                                    <td><?php echo $array_TM    [$x][11]; ?></td>
                                    <td><?php echo $array_PSW   [$x][11]; ?></td>
                                    <td><?php echo $array_TK    [$x][11]; ?></td>
                                    <td><?php echo $array_HTW   [$x][12]; ?></td>
                                    <td><?php echo $array_TM    [$x][12]; ?></td>
                                    <td><?php echo $array_PSW   [$x][12]; ?></td>
                                    <td><?php echo $array_TK    [$x][12]; ?></td>
                                </tr>        
