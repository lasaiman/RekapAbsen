...
require_once("config.php");
    if(!isset($_SESSION["user"])){
        ...
        exit;
                ...
                $no=1;
$q="select*from tlg where no=2"; $q1=mysqli_query($conn,$q);
            ?>
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <?php
                ...
                <tr>
                  ...
                  <td><?php echo $row['id_kyn'];?></td>
                  <td><?php echo $row['nama_kyn'];?></td>
                  <td><?php echo $row['jabatan'];?></td>
                  <td><?php echo $row['no_tlp'];?></td>
                  <td>
                  <a href="delete_karyawan.php?id_kyn=<?php echo $row['id_kyn']; ?>" onclick="return confirm('Anda yakin hapus ?')">Delete</a>
                              <a href="update_karyawan.php?id_kyn=<?php echo $row['id_kyn']; ?>">Update</a>
                  </td>
                </tr>
                <?php
                    }
